...
if __name__=="__main__":
    ...
    parser.add_argument('--weights', type=str, default='output/360CC/crnn/2023-10-14-22-14/checkpoints/checkpoint_4_acc_0.9017.pth', help='weights path')  # from yolov5/models/
    parser.add_argument('--save_path', type=str, default='best.onnx', help='onnx save path')
    parser.add_argument('--img_size', type=list, default=[48, 168], help='image size')  # height, width
    ...
    # Make input
    input = torch.randn(opt.batch_size, 3, opt.img_size[0], opt.img_size[1])
