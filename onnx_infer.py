...
if __name__ == "__main__":
    ...
    parser.add_argument('--onnx_file', type=str, default='best.onnx', help='model.pt path(s)')#识别模型
    parser.add_argument('--image_path', type=str, default='test_images/1.jpg', help='source')
